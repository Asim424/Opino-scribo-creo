...
/** @type {string} */
const CACHE_VERSION = '1770274858|222428098416';
/** @type {string} */
const CACHE_PREFIX = 'Opino scribo cre-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Opino scribo creo.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Opino scribo creo.html","Opino scribo creo.js","Opino scribo creo.offline.html","Opino scribo creo.icon.png","Opino scribo creo.apple-touch-icon.png","Opino scribo creo.audio.worklet.js","Opino scribo creo.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Opino scribo creo.wasm","Opino scribo creo.pck"];
