...
func move_enemies(player_pos : Array):
	if not alr_moved:
		if (abs(room_position[1] - player_pos[1]) == 1 and abs(room_position[0] - player_pos[0]) == 0) or (abs(room_position[1] - player_pos[1]) == 0 and abs(room_position[0] - player_pos[0]) == 1):
